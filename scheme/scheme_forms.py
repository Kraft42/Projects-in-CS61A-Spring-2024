...
def do_define_form(expressions, env):
    ...
    if scheme_symbolp(signature):
        ...
        # BEGIN PROBLEM 10
        "*** YOUR CODE HERE ***"
        symbol,formal = signature.first,signature.rest
        Lambda_Procedure_Instance = do_lambda_form(Pair(formal,expressions.rest),env)
        env.define(symbol,Lambda_Procedure_Instance)
        return symbol
        # END PROBLEM 10
    else:
...
def do_and_form(expressions, env):
    ...
    is_first_true = is_scheme_true(first_eval)
    if expressions.rest is nil and is_first_true:
        return first_eval
    else:
        return is_first_true and do_and_form(expressions.rest,env)
    # END PROBLEM 12
...
def do_or_form(expressions, env):
    ...
    if is_first_true:
        ...
        return False or do_or_form(expressions.rest,env)
    # END PROBLEM 12
...
def make_let_frame(bindings, env):
    ...
    while bindings is not nil:
        ...
        if validate_form(binding,2,2) is None:
